...
def run_sft(
    ...
    model = load_model(tokenizer, model_args, finetuning_args, training_args.do_train, full_determinism=training_args.full_determinism, neat_packing=data_args.neat_packing)
