# modified from https://github.com/feifeibear/long-context-attention/blob/main/yunchang/ulysses/hybrid/attn_layer.py
...
from yunchang.hybrid.utils import RING_IMPL_DICT, RING_IMPL_QKVPACKED_DICT
...
class LongContextAttention(torch.nn.Module):
    ...
    def __init__(
        self,
        sequence_parallel_ulysses_group: dist.ProcessGroup = None,
        sequence_parallel_ring_group: dist.ProcessGroup = None,
        scatter_idx: int = 2,
        gather_idx: int = 1,
        ...
        self.ring_pg = sequence_parallel_ring_group
        self.ulysses_pg = sequence_parallel_ulysses_group
